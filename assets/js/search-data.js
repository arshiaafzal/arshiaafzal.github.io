...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-thrilled-to-receive-an-internship-offer-from-cartesia-ai-working-on-state-space-models-for-audio-generation",
          title: '🤖 Thrilled to receive an internship offer from Cartesia AI! Working on state...',
          description: "",
