...
date: 2026-04-12
featured: false
thumbnail: assets/img/raven_walnut.png
...
<div style="background:#f8f9fa; border-left:3px solid #adb5bd; padding:0.6rem 1rem; margin-bottom:0.75rem; border-radius:0 4px 4px 0; font-size:0.9rem;">
  This post is cross-posted at <a href="https://goombalab.github.io/blog/2026/raven-part2/" target="_blank">Goomblab Blog</a>.
</div>
...
{% include figure.liquid loading="eager" path="assets/img/raven_arch.png" title="block diagram" caption="Raven block design vs. other linear models block design." width="60%" max-width="60%" class="rounded mx-auto d-block" %}
